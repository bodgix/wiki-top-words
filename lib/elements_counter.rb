...
module ElementsCounter
  ...
  def elements_with_count(&block)
    ...
    # Don't have a good idea how to write it better in multiple lines
    @elements_with_count ||= to_a.each_with_object(Hash.new(0)) do |element, counter|
      transformed_element = block && yield(element) || element
